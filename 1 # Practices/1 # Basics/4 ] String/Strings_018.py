...
print("My Name is : {} And My Age : {} And My Rank : {}".format(name, age, rank))
print("My Name is : {:s} And My Age : {:d} And My Rank : {:f}".format(name, age, rank))
print("My Name is : {:.4s} And My Age : {:d} And My Rank : {:.2f}".format(name, age, rank))
m = 5030323948
print("this my money : {:-d}".format(m))
a, b, c = 'one', 'tow', 'three'
print("this my number : {} {} {}".format(a, b, c))
print("this my number : {1} {2} {0}".format(a, b, c))
print("this my number : {2} {1} {0}".format(a, b, c))

a, b, c = 'one', 'tow', 'three'
print("this my number : {} {} {}".format(a, b, c))
print("this my number : {1:.2s} {2:s} {0:s}".format(a, b, c))
print("this my number : {2} {1} {0}".format(a, b, c))
